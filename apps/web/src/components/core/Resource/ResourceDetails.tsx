        ...
        <div>
         ...
         <div className='flex flex-col'>
            ...
            <p>{resource.size}</p>
                    ...
                    <div>
                        <Button className='mt-5 py-1 text-md bg-blue-300 text-blue-600'>Personal</Button>
               ...
               <div className='w-1/5 mx-2 flex flex-col gap-3 '>
                <Button className='w-full bg-orange-400 hover:bg-orange-950'>Download 91.8</Button>
                <div className='w-full  bg-white rounded-md'>
                    <h3 className='text-xl text-slate-800 font-semibold p-2'>Related Course</h3>
                    {ResourcesList.map((resource) => (
          // Add key prop for each element in the map
          <div className='bg-white rounded-xl' key={resource.id}>
            <div className=''>
         <div className='flex flex-row'>
            <img className='rounded-t-xl w-12' src={resource.tambnail} alt={resource.title} />
            <p className='px-3'>{resource.title} </p>
            </div>
            <div className='p-4 flex flex-row gap-3'>
            <p className='bg-blue-200 px-2 hover:text-blue-500 rounded-xl cursor-pointer'>{resource.category}</p>
